...
(defvar insert-time-string-default-format "locale") ; changed from "locale" to iso-8601-date
(current-time)
...
;; (insert-time-string "%Y-%m-%d")2017-01-26

(format-time-string "%b. %e, %Y")

(calendar-absolute-from-gregorian '(2017 1 20))
(calendar-absolute-from-gregorian (current-time))
