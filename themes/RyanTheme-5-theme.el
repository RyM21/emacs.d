...
(custom-theme-set-faces
 ...
 '(org-document-title ((t (:family "Lucida Grande" :height 1.2 :underline nil :box nil :foreground "gold" :inherit org-level-1))))
 '(org-tag ((t (:foreground "cyan" :weight bold :height 1.0 :family "Inconsolata"))))
 '(org-default ((t nil)))
