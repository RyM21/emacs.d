...
(custom-theme-set-variables
 ...
 '(auth-sources (quote (quote ("~/.authinfo.gpg" "~/.netrc"))))
 '(gnus-mode-line-image-cache (quote (quote (image :type xpm :ascent center :data "/* XPM */
...
(custom-theme-set-faces
 ...
 '(default ((t (:background "#2e3436" :foreground "#eeeeec" :family "Inconsolata"))))
 '(elfeed-search-title-face ((t (:foreground "light blue" :height 1.0))))
